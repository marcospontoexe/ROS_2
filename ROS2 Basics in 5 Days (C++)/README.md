...
1.  [Pacotes](#pacotes)
    ...
    *   [Arquivos Launch (arquivo de inicialização)](#arquivos-launch-arquivo-de-inicialização)
    *   [Criando um arquivo de programa](#criando-um-arquivo-de-programa)
    *   [CMakeLists.txt](#cmakeliststxt)
    *   [Compilando pacotes](#compilando-pacotes)
2.  [Node (nós)](#node-nós)
    *   [Node Composition (composição do nós)](#node-composition-composição-do-nós)
        *   [Vantagens de usar múltiplos nós no mesmo executável (mesmo processo)](#vantagens-de-usar-múltiplos-nós-no-mesmo-executável-mesmo-processo)
3.  [Tópicos](#tópics)
    *   [Publisher](#publisher)
    *   [Subscribers (Assinante)](#subscribers-assinante)
4.  [Messages (interfaces)](#messages-interfaces)
    *   [Criando uma interface (mensagem) customizada](#criando-uma-interface-mensagem-customizada)
        *   [Criando o arquivo de interface](#criando-o-arquivo-de-interface)
        *   [Modificando o arquivo CMakeLists.txt](#modificabdo-o-arquivo-cmakeliststxt)
        *   [Modificando o arquivo package.xml](#modificabdo-o-arquivo-packagexml)
    *   [Usando uma interface (mensagem) customizada](#usando-uma-interface-mensagem-customizada)
5.  [Executors and Callback Groups](#executors-and-callback-groups)
    *   [Executor](#executor)
        *   [Tipos de Executors](#tipos-de-executors)
        *   [Executor executando nó mínimo](#executor-executando-nó-mínimo)
        *   [Executor executando nó mínimo com callback](#executor-executando-nó-mínimo-com-callback)
        *   [Single-Threaded Executor executando um nó com duas funções de Callback](#single-threaded-executor-executando-um-nó-com-duas-funções-de-callback)
        *   [Multi-Threaded Executor executando dois nós](#multi-threaded-executor-executando-dois-nós)
        *   [Dois nós em execução em dois executors diferentes](#dois-nós-em-execução-em-dois-executors-diferentes)
    *   [Callback Groups](#callback-groups)
        *   [Tipos de Callback Groups](#tipos-de-callback-groups)
        *   [Reentrant Callback Groups](#reentrant-callback-groups)
        *   [Mutually Exclusive Callback Groups](#mutually-exclusive-callback-groups)
        *   [Múltiplos Mutually Exclusive Callback Groups](#multiplos-mutually-exclusive-callback-groups)
6.  [Services](#services)
    *   [Service Client](#service-client)
        *   [Chamando um serviço a partir de um spinning node](#chamando-um-serviço-a-partir-de-um-spinning-node)
    *   [Service Server](#service-server)
    *   [Interfaces de serviço personalizadas](#interfaces-de-serviço-personalizadas)
        *   [Editando o CMakeLists.txt](#editando-o-cmakeliststxt)
        *   [Editando o package.xml](#editando-o-packagexml)
    *   [Usando interfaces de serviço personalizadas](#usando-interfaces-de-serviço-personalizadas)
7.  [Actions](#actions)
    *   [Chamando um action server](#chamando-um-action-server)
    *   [Actions fornecendo feedback](#actions-fornecendo-feedback)
    *   [Action Client](#action-client)
    *   [Action Server](#action-server)
    *   [Action Interface customizada](#action-interface-customizada)
        *   [Modificando o CMakeLists.txt](#modificando-o-cmakeliststxt-1)
        *   [Modificando o Cpackage.xml](#modificando-o-cpackagexml)
    *   [Usando uma action Interface customizada](#usando-uma-action-interface-customizada)
8.  [Node Composition](#node-composition)
    *   [Componentes](#componentes)
    *   [Composição em tempo de execução](#composição-em-tempo-de-execução)
    *   [Iniciando uma componente com um arquivo launch](#iniciando-uma-componente-com-um-arquivo-launch)
    *   [Composição em tempo de compilação](#composição-em-tempo-de-compilação)
9.  [Ferramentas de Debugging (Depuração)](#ferramentas-de-debugging-depuração)
    *   [ROS2 Debugging Messages](#ros2-debugging-messages)
    *   [RVIZ2](#rviz2)
    *   [Visualizar os frames do robô](#vizualizar-os-frames-do-robo)
    *   [ROS2 Doctor](#ros2-doctor)
        *   [O que o `ros2 doctor` faz?](#o-que-o-ros2-doctor-faz)
        *   [Quando usar o `ros2 doctor`?](#quando-usar-o-ros2-doctor)
        *   [Verifique toda a sua configuração](#verifique-toda-a-sua-configuração)
        *   [Obtenha um relatório completo com o ROS2 Doctor](#obtenha-um-relatório-completo-com-o-ros2-doctor)
